...
//        if (n == 1) {//LEFT
//            if (V == 1) {//RED
//                forward(0.2, end, 0.001);
//                leftward(0.2, far, 0.001);
//            } else{
//                backward(0.2, end, 0.001);
//                round(0.2, r);
//                round(0.2, r);
//                rightward(0.2, near, 0.001);
//                sleep(700);
//            }
//        }
//        if (n == 2) {//RIGHT
//            sleep(500);
//            if (V == 1) {//RED
//                forward(0.2, end, 0.00);
//                leftward(0.2, near, 0.001);
//                sleep(700);
//            } else {
//                backward(0.2, end, 0.001);
//                round(0.2, r);
//                round(0.2, r);
//                rightward(0.2, far, 0.001);
//                sleep(700);
//            }
//        }
//        if (n == 3) {//Center
...
//            if (V == 1) {//RED
//                forward(0.2, end, 0.001);
//                leftward(0.2, center, 0.001);
//                sleep(700);
//            } else {
//                backward(0.2, end, 0.001);
//                round(0.2, r);
//                round(0.2, r);
//                rightward(0.2, center, 0.001);
//                sleep(700);
//            }
//        }
//        Lift.setPower(-0.5);
